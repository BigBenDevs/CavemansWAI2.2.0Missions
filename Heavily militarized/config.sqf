if(isServer) then {
	...
	/* WAI MISSIONS CONFIG */
		...
		military_armed				= ["T34_TK_EP1","BRDM2_TK_EP1","BAF_Jackal2_L2A1_w"];
		utility_vehicles			= ["SUV_TK_CIV_EP1","SUV_Charcoal","SUV_Red","SUV_Orange","SUV_White"];							
		...
		crate_items_buildables 		= [["metal_floor_kit",25],"forest_large_net_kit","cinder_garage_kit",["PartPlywoodPack",5],"ItemSandbagExLarge5X","park_bench_kit","ItemComboLock",["CinderBlocks",10],"ItemCanvas","ItemComboLock",["ItemLightBulb",5],"ItemLockbox",["ItemSandbag",10],["ItemTankTrap",10],["ItemWire",10],["MortarBucket",10],["PartPlankPack",5],"PartWoodPile"];
		...
		crate_items_president 		= ["ItemDocument","ItemGoldBar100oz"];
		crate_items_crop_raider  	= ["ItemKiloHemp"];
		crate_items_gem_tower  		= ["ItemRuby","ItemEmerald","ItemSapphire","ItemObsidian","ItemTopaz","ItemCitrine"];
