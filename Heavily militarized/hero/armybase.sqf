...
_baserunover42 = createVehicle ["Land_Fire_barrel_burning",[(_position select 0) - 0.01, (_position select 1) - 0.01,-0.02],[], 0, "CAN_COLLIDE"];
	...
	//Troops
	[[(_position select 0) - 12, (_position select 1) + 2, 0],4,"Hard",["Random","AT"],4,"Random","CDF_Soldier_Light","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 2, (_position select 1) + 2, 0],4,"Hard","Random",4,"Random","CDF_Soldier_Officer","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 14, (_position select 1) - 35, 0],4,"Hard","Random",4,"Random","CDF_Soldier_Light","Random","Bandit",_mission] call spawn_group;
	[[(_position select 0) + 13, (_position select 1) + 35, 0],4,"Hard","Random",4,"Random","CDF_Soldier_Officer","Random","Bandit",_mission] call spawn_group;
