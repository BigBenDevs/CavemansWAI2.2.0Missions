...
_baserunover14 = createVehicle ["fiberplant",[(_position select 0) + 12, (_position select 1) - 23,-0.02],[], 0, "CAN_COLLIDE"];
	...
	//Troops
	[[(_position select 0) - 1, (_position select 1) - 10, 0],4,"Hard",["Random","AT"],4,"Random","TK_GUE_Soldier_MG_EP1","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) - 2, (_position select 1) - 50, 0],4,"Hard","Random",4,"Random","TK_GUE_Soldier_Sniper_EP1","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) - 1, (_position select 1) + 11, 0],4,"Hard","Random",4,"Random","TK_GUE_Soldier_Warlord_EP1","Random","Hero",_mission] call spawn_group;
